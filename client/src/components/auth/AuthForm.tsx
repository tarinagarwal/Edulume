...
const AuthForm: React.FC<AuthFormProps> = ({ onAuthChange }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/"), isLogin ? 100 : 1000);
    } catch (err: any) {
        ...
        <div className="smoke-card p-8 relative smoke-effect">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {renderInput(
                  ...
                  !otpSent && (
                    <button
                      ...
                      className="mt-2 text-sm text-alien-green hover:text-alien-green-dark disabled:opacity-50"
                    >
                ...
                {showOTPField &&
                  renderInput(
                    ...
                    <button
                      ...
                      onClick={handleSendOTP}
                      disabled={otpLoading}
                      className="mt-2 text-sm text-gray-400 hover:text-alien-green"
                    >
                      Resend Code
                    </button>
                  )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="alien-button w-full py-3 text-lg disabled:opacity-50"
            >
          ...
          <div className="mt-6">
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-smoke-light" />
              </div>
            ...
            <a
              ...
              className="mt-6 w-full flex items-center justify-center gap-3 px-4 py-3 border border-smoke-light rounded-lg text-white hover:bg-smoke-light hover:text-black transition-colors"
            >
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="text-alien-green hover:text-alien-green-light"
            >
              {isLogin
          ...
          {isLogin && (
            <div className="mt-4 text-center">
              <button
                ...
                className="text-sm text-gray-400 hover:text-alien-green"
              >
